...
const projects: ProjectData[] = [
  {
    ...
    description:
      'A hackathon platform designed to help participants discover opportunities, form teams and manage their project journey.',
  ...
  },
  {
    ...
    badge: 'HARDWARE & IOT',
    description:
      'An IoT-focused safety system built around SOS alerts, real-time location capture and Firebase-powered event tracking.',
  ...
  },
  {
    ...
    number: '03',
    title: 'ECOQUEST',
    category: 'Gamified Environmental Experience',
